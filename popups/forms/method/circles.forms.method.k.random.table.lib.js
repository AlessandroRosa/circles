...
function CIRCLESmethodMANAGERrandomTABLEbuild( _show )
{
    ...
    if ( _glob_process != PROCESS_RANDOM )
    {
       ...
       HTMLcode += "<tr><td CLASS=\"link\" ALIGN=\"center\" STYLE=\"font-size:12pt;color:#8FBAC8;\" ONCLICK=\"javascript:_glob_process=PROCESS_RANDOM;_glob_fixedpt_io=FIXEDPOINTS_IO_INPUT;circles_lib_popup_load('forms','method',2,NO,_glob_method,null);CIRCLESmethodMANAGERrandomTABLEmultisliderINIT();circles_lib_menu_entries_update();\">Set process to random and Reload</td></tr>" ;
       HTMLcode += "<tr><td HEIGHT=\"24\"></td></tr>" ;
       HTMLcode += "</table>" ;
