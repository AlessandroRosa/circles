...
function CIRCLESformsDISCRETENESSLOCUSmain( _base_id, _move )
{
    ...
    if ( _plugin_tmp_vars_config_array[GLOB_PLUGIN_SUBSET] == null ) _plugin_tmp_vars_config_array[GLOB_PLUGIN_SUBSET] = [] ;
    _plugin_tmp_vars_config_array[GLOB_PLUGIN_SUBSET][GLOB_PLUGIN_BASE_ID] = _div_id ;
