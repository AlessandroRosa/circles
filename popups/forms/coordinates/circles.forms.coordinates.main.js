...
function CIRCLESformsCOORDINATESmain( _base_id, _move, _plane_type )
{
    ...
    HTMLcode += "<td WIDTH=\"15\"></td>" ;
    HTMLcode += "<td CLASS=\"link_rounded\" ONCLICK=\"javascript:CIRCLESformsCOORDINATESinputMANAGER( "+_plane_type+", "+_render+", '"+REFRESH_FN+"', ZOOM_GET_COORDS, null, null, "+_question+", "+_silent+" );\">Set coords</td>" ;
