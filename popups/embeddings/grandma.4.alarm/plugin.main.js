function CIRCLESembeddingsGRANDMA4ALARM_TOGGLE_GENS() { $("#PLUGIN_CONTAINER").slideToggle( "slow", function() { $("#PLUGIN_GENSTOGGLE_BTN").html( $("#PLUGIN_CONTAINER").css( "display" ) == "none" ? "Show panel" : "Hide panel" ); } ); }
function CIRCLESembeddingsGRANDMA4ALARM_MINIMAXI_TOGGLE()
{
	  ...
	  if ( event.cancelBubble != null ) event.cancelBubble = true;
		...
		switch( event.keyCode )
		{
             ...
             else if ( ctrl_id.strcmp( "PLUGIN_PARAM_AB" ) )
             {
                 ...
                 {
                    if ( _plugin_step_index == 1.1 ) CIRCLESembeddingsGRANDMA4ALARM_REGISTER_PARAMS();
...
function CIRCLESembeddingsGRANDMA4ALARM_REGISTER_PARAMS()
{
...
function CIRCLESembeddingsGRANDMA4ALARMmain( _base_id, _move, _restore )
{
    ...
    HTMLcode += circles_lib_popup_caption_code( YES, _glob_submethod_desc, 1, YES, "GLOB_PLUGIN_CLOSE_POPUP();", WIDTH, HEIGHT, this_fn_name, 'grandma.4.alarm', _div_id, 'embeddings', "plug/plug.icon.01.16x16.png", "", "", "CIRCLESembeddingsGRANDMA4ALARM_",
