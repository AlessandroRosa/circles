function CIRCLEStoolsFUNDAMENTALREGIONdispatcher()
{
      ...
      */ 
			if ( arguments.length > 0 )
			{
              ...
              if ( $('#'+CIRCLEStoolsFUNDAMENTALREGIONdiv_id).resizable('instance') != undefined )
							$("#"+CIRCLEStoolsFUNDAMENTALREGIONdiv_id).resizable('destroy');

              if ( $( "#" + CIRCLEStoolsFUNDAMENTALREGIONdiv_id ).resizable('instance') != undefined ) $("#" + CIRCLEStoolsFUNDAMENTALREGIONdiv_id).resizable('destroy');
              if (  $( "#CIRCLEStoolsFUNDAMENTALREGIONworkLAYER" ).get(0) != null )
              {
