...
<?php require_once( "../fns/fns.php" ) ;
      ...
      $fullpath = "$PATH_TO_CIRCLES_FOLDER$folder/" ;
      if ( file_exists( $fullpath ) )
      {
          $filelist = scan_folder( $fullpath, "/$filter/i", $inc_file_data, $recursive, $showfiles, $showfolders ) ;
          $out_array = array();
          foreach( $filelist AS $chunk ) $out_array[] = $chunk['time'] ;
