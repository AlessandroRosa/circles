function _canvas_draw_circle( _canvas, _center_x, _center_y, _radius, _border, _bordercolor, _fill, _fillcolor, _bordersize, _opacity )
{
     if ( !object_exists( _canvas ) || !( _canvas instanceof HTMLCanvasElement ) ) return NO ;

     if ( isNaN( _border ) ) _border = 0 ;
     if ( isNaN( _fill ) ) _fill = 0 ;
     if ( !object_exists( _bordercolor ) ) _bordercolor = "" ;
     if ( !object_exists( _fillcolor ) ) _fillcolor = "" ;

     _bordersize = ( !object_exists( _bordersize ) ) ? 0 : parseInt( _bordersize, 10 ) ;
     if ( isNaN( _bordersize ) ) _bordersize = 0 ;
     ...
     {
         // _border the dashed circle only in the source plane
         // no action in the image plane when _border = 0
...
function _canvas_draw_line( _canvas, mapper, _from_x, _from_y, _to_x, _to_y, _bordercolor, _bordersize, _opacity )
{
     if ( !object_exists( _canvas ) || !( _canvas instanceof HTMLCanvasElement ) ) return NO ;
		 var _context = _canvas.getContext( "2d" ) ;
...
function _canvas_polyline( _canvas, POINTSarray, _bordercolor, _bordersize, _close, _opacity )
{
     if ( !object_exists( _canvas ) || !( _canvas instanceof HTMLCanvasElement ) ) return NO ;
		 var _context = _canvas.getContext( "2d" ) ;
     ...
     if ( _p_length > 0 )
     {
         ...
         for( var i = 1 ; i < _p_length ; i++ )
         {
             ...
             _canvas_draw_line( _canvas, FROM_PT.x, FROM_PT.y, TO_PT.x, TO_PT.y, _bordercolor, _bordersize, _opacity ) ;
         }
...
function _canvas_draw_rect( _canvas, _rect_obj, _border, _bordercolor, _fill, _fillcolor, _bordersize, _map_it, _opacity )
{
     if ( !object_exists( _canvas ) || !( _canvas instanceof HTMLCanvasElement ) ) return NO ;
		 var _context = _canvas.getContext( "2d" ) ;
...
function _canvas_draw_point( _canvas, _x, _y, _border, _bordercolor, _fill, _fillcolor, _bordersize, radius, _opacity )
{
     if ( !object_exists( _canvas ) || !( _canvas instanceof HTMLCanvasElement ) ) return NO ;
		 var _context = _canvas.getContext( "2d" ) ;

     if ( _border == null || _border == "undefined" ) _border = YES ;
     ...
     if ( !object_exists( _bordersize ) ) _bordersize = 0 ;
     _bordersize = parseInt( _bordersize, 10 );
     if ( isNaN( _bordersize ) ) _bordersize = 0 ;
