...
<tr>
    ...
    <tr>
    <td WIDTH="2"></td>
    <td HEIGHT="20" WIDTH="50" CLASS="link_rounded" ALIGN="center" ID="STATUSBARdrawdisksBTN" ONCLICK="javascript:circles_lib_alphabet_autoconfig_all_symbols(!_glob_terminal_silent,_glob_terminal_silent,NO,OUTPUT_SCREEN);">Auto-config</td>
    </tr>
    <tr><td HEIGHT="2"></td></tr>
    ...
    <td WIDTH="2"></td>
    <td WIDTH="6" ONCLICK="javascript:circles_lib_popup_hide_all();" TITLE="Hide all pop-ups" CLASS="status_bar_hide_all_popups"></td>
</tr>
<tr><td HEIGHT="2"></td></tr>
</table>