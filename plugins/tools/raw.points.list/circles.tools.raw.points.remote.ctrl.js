function CIRCLEStoolsRAWPOINTS_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLEStoolsRAWPOINTSremotectrl( _options, _return_fn, _ret_array, _out_channel )
{
	...
	var _out_msg = "" ;
    var _idx = circles_lib_plugin_find_index( { subset : "tools", base_id : "raw.points.list" }, POPUP_SEARCH_BY_SUBSET | POPUP_SEARCH_BY_BASE_ID, 0 ) ;
    var _div_id = _idx != UNFOUND ? _glob_popups_array[_idx][1] : "" ;
	switch( _options[0].toLowerCase() )
	{
        case "close":
        GLOB_PLUGIN_DESTROY_POPUP_VARS();
        var _sub = "forms", _base_id = "raw.points".replace( /[\.\_\-]/g, '' ) ;
        ...
        break ;
		case "focus":
        var _sub = "forms", _base_id = "raw.points" ;
