...
function CIRCLEStoolsALPHABETCOLORIZATIONmain( _base_id, _move )
{
	...
	var _this_fn_name = "CIRCLEStoolsALPHABETCOLORIZATIONmain" ;
    ...
    HTMLcode += circles_lib_plugin_caption_code( YES, CIRCLEStoolsALPHABETCOLORIZATIONcaption, 5, 1, CLOSE_FN, WIDTH, HEIGHT, _this_fn_name, _base_id, _div_id, _subset, "abc/abc.icon.01.20x20.png" );
    ...
    circles_lib_plugin_activate( NO, _base_id, arguments.callee.name, arguments, 'tools', OPEN, _div_id, CIRCLEStoolsALPHABETCOLORIZATIONcaption, CLOSE_FN );
