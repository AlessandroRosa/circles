function CIRCLEStoolsCANVASCOMPOSITION_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLEStoolsCANVASCOMPOSITIONremotectrl( _options, _return_fn, _ret_array, _out_channel )
{
	...
	var _out_msg = "" ;
    var _idx = circles_lib_plugin_find_index( { subset : "forms", base_id : "canvas.composition" }, POPUP_SEARCH_BY_SUBSET | POPUP_SEARCH_BY_BASE_ID, 0 ) ;
    var _div_id = _idx != UNFOUND ? _glob_popups_array[_idx][1] : "" ;
	switch( _options[0].toLowerCase() )
	{
        case "close":
        GLOB_PLUGIN_DESTROY_POPUP_VARS();
        var _sub = "forms", _base_id = "canvas.composition".replace( /[\.\_\-]/g, '' ) ;
        ...
        break ;
		case "focus":
        var _sub = "forms", _base_id = "canvas.composition" ;
