function CIRCLESformsSCRIPTEDITOR_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLESformsSCRIPTEDITORremotectrl( _options, _return_fn, _ret_array, _out_channel )
{
	...
	switch( _options[0].toLowerCase() )
	{
        ...
        var _sub = "forms", _base_id = "script.editor".replace( /[\.\_\-]/g, '' ) ;
