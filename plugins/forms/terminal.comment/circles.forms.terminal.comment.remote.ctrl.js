function CIRCLESformsTERMINALCOMMENT_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLESformsTERMINALCOMMENTremotectrl( _options, _return_fn, _out_channel )
{
       ...
       if ( typeof _return_fn === "function" ) _return_fn.call( this, "<orange>Invalid input data for remote control management</orange>" );
		...
		var _out_msg = "" ;
    var _idx = circles_lib_plugin_find_index( { subset : "forms", base_id : "terminal.comments" }, POPUP_SEARCH_BY_SUBSET | POPUP_SEARCH_BY_BASE_ID, 0 ) ;
    var _div_id = _idx != UNFOUND ? _glob_popup_array[_idx][1] : "" ;
        ...
        var _sub = "forms", _base_id = "terminal.comment" ;
