function CIRCLESformsTERMINALCOMMENTdispatcher()
{
      ...
      */ 
          ...
          var _idx = circles_lib_plugin_find_index( { subset : "forms", base_id : "terminal.comment" }, POPUP_SEARCH_BY_SUBSET | POPUP_SEARCH_BY_BASE_ID, 0 )
