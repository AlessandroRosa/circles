function CIRCLESformsTANGENTCIRCLE_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLESformsTANGENTCIRCLEremotectrl( _options, _return_fn, _ret_array, _out_channel )
{
	...
	switch( _options[0].toLowerCase() )
	{
        ...
        var _sub = "forms", _base_id = "tangent.circle".replace( /[\.\_\-]/g, '' ) ;
        ...
        break ;
		case "focus":
        var _sub = "forms", _base_id = "tangent.circle" ;
