function CIRCLESformsCHECKITEMS_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLESformsCHECKITEMSremotectrl( _options, _return_fn, _ret_array, _out_channel )
{
	...
	switch( _options[0].toLowerCase() )
	{
        ...
        var _sub = "forms", _base_id = "check.items".replace( /[\.\_\-]/g, '' ) ;
        ...
        break ;
		case "focus":
        var _sub = "forms", _base_id = "check.items" ;
