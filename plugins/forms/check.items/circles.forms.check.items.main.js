    ...
    if ( _items_n > 0 )
    {
        ...
        else if ( _glob_method.is_one_of( METHOD_INVERSION, METHOD_ALGEBRAIC ) )
        {
            ...
            if ( _err_mask_whole & 4 || _err_mask_whole & 32 )
            {
              ...
              HTMLcode += "<td WIDTH=\"10\"></td>" ;
              HTMLcode += "<td CLASS=\"link_rounded\" ONCLICK=\"javascript:if ( confirm( _QUESTION_20_03 ) ) { circles_lib_items_init_group_from_maps( YES, NO );circles_lib_canvas_render_zplane(_glob_zplane_rendering_layer_pointer,zplane_sm,null,YES,YES,YES,NO,YES);CIRCLESformsCHECKITEMSmain(CIRCLESformsCHECKITEMSbaseid);}\">Create circles</td>" ;
            }
            HTMLcode += "</tr>" ;
            HTMLcode += "</table>" ;
            HTMLcode += "</td>" ;
