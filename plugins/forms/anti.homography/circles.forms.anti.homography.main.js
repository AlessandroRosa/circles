...
function CIRCLESformsANTIHOMOGRAPHYapply( _items_switch = ITEMS_SWITCH_SEEDS )
{
...
function CIRCLESformsANTIHOMOGRAPHYlist( _items_switch = ITEMS_SWITCH_SEEDS, _update = NO )
{
