function CIRCLESformsCIRCLEINVERSIONdispatcher()
{
      ...
      */ 
          ...
          var _idx = circles_lib_plugin_find_index( { subset : "forms", base_id : "circle.inversion" }, POPUP_SEARCH_BY_SUBSET | POPUP_SEARCH_BY_BASE_ID, 0 )
