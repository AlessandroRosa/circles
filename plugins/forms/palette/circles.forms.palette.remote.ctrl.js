function CIRCLESformsPALETTEREMOTE_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLESformsPALETTEREMOTEremotectrl( _options, _return_fn, _ret_array, _output_channel )
{
       ...
       if ( typeof _return_fn === "function" ) _return_fn.call( this, "<orange>Invalid input data for remote control management</orange>" );
		...
		var _out_msg = "" ;
    var _idx = circles_lib_plugin_find_index( { subset : "forms", base_id : "palette" }, POPUP_SEARCH_BY_SUBSET | POPUP_SEARCH_BY_BASE_ID, 0 ) ;
