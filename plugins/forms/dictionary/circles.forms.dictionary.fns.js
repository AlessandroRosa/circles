             ...
             if ( _alphabet.length > 0 )
             {
                 ...
                 if ( _b_go )
                 {
                     ...
                     if ( !_question ? YES : confirm( _question ) )
                     {
                         ...
                         if ( circles_lib_plugin_find_index( { subset : "forms", base_id : 'dictionary' }, POPUP_SEARCH_BY_BASE_ID | POPUP_SEARCH_BY_SUBSET ) != UNFOUND )
...
{
    if ( circles_lib_plugin_find_index( { div_id : "POPUPterminalDIV" + _glob_terminal_form_suffix }, POPUP_SEARCH_BY_DIV_ID | POPUP_SEARCH_BY_SUBSET ) == UNFOUND )
