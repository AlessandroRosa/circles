function CIRCLESformsDICTIONARY_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLESformsDICTIONARYremotectrl( _options, _return_fn, _out_channel )
{
    ...
    var _div_id = _idx != UNFOUND ? _glob_popup_array[_idx][1] : "" ;
        ...
        var _sub = "forms", _base_id = "dictionary" ;
