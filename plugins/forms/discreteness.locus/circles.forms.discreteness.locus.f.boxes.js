...
function CIRCLESformsDISCRETENESSLOCUStuningsMAIN_BOX()
{
    ...
    HTMLcode += "<tr><td WIDTH=\"3\"></td><td>Arrow line size</td><td WIDTH=\"3\"></td><td><INPUT TYPE=\"edit\" ONKEYUP=\"javascript:CIRCLESformsDISCRETENESSLOCUSeventsHANDLER(event,this.id);\" STYLE=\"width:40px;text-align:center;color:#C0C0C0;\" DISABLED VALUE=\"2\" ID=\"CIRCLESformsDISCRETENESSLOCUSarrowlinethick\"></td></tr>" ;
