...
function CIRCLESformsEDITDISKgraphixCODE( _index, _items_switch )
{
    ...
    var bordersize = _b_circle_exists ? ITEM.complex_circle.bordersize : 1 ;
    var fill = _b_circle_exists ? ITEM.complex_circle.fill : NO ;
    var draw = _b_circle_exists ? ITEM.complex_circle.draw : NO ;
    var bordercolor = _b_circle_exists ? ITEM.complex_circle.bordercolor : _glob_draw_seed_color ;
    ...
    HTMLcode += "<tr>" ;
    HTMLcode += "<td WIDTH=\"5\"></td>" ;
    HTMLcode += "<td ID=\"bordercolorLABEL\">Border color</td>";
    HTMLcode += "<td WIDTH=\"5\"></td>";
    HTMLcode += "<td CLASS=\"general_rounded_corners\" STYLE=\"text-align:center;height:24px;width:20px;background-color:"+bordercolor+";\" ID=\"CIRCLEScircleSELECTEDbordercolor\">"+( ( draw == 0 && bordercolor.length == 0 ) ? "<span STYLE=\"font-size:7pt;color:#808080;\">none</span>" : "" )+"</td>";
    HTMLcode += "<td WIDTH=\"5\"></td>";
    HTMLcode += "<td ONMOUSEOVER=\"javascript:this.style.cursor='pointer';\"";
    HTMLcode += "    ONCLICK=\"javascript:$('#CIRCLESformsEDITDISKapplyBTN').css('color','red');_glob_to_save=YES;circles_lib_extras_button_enable('APPLYchangesBTN', _glob_to_save,1);displayCOLORTABLE( 'CIRCLEScircleSELECTEDbordercolorICON', 'CIRCLEScircleSELECTEDbordercolor' );\"";
    ...
    HTMLcode += "<td WIDTH=\"5\"></td>" ;
    HTMLcode += "<td CLASS=\"link_rounded\" ONCLICK=\"$('#CIRCLESformsEDITDISKapplyBTN').css('color','red');javascript:$('#CIRCLESformsEDITDISKapplyBTN').css('color','red');CIRCLESformsEDITDISKsetTRANSPARENTbordercolor( "+_index+" );\">Transparent</td>" ;
    HTMLcode += "</tr>" ;
...
function CIRCLESformsEDITDISKpropertiesCODE( _index, _items_switch )
{
    ...
    var area = ( _b_exists && is_circle( complex_circle ) ) ? complex_circle.area() : 0 ;
      ...
      HTMLcode += "<table>" ;
      HTMLcode += "<tr>" ;
      HTMLcode += "<td "+( ( !_b_exists || bISNULL ) ? "CLASS=\"linkdead\"" : "CLASS=\"link_rounded\" ONCLICK=\"javascript:CIRCLESmarklimitset("+_index+", _glob_zplane_rendering_layer_placeholder );\"" )+">Mark fixed points</td>" ;
      HTMLcode += "<td WIDTH=\"10\"></td>" ;
