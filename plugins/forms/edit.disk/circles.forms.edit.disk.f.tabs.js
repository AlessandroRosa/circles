...
function CIRCLESformsEDITDISKpropertiesCODE( _index, _items_switch )
{
    ...
    var area = ( _b_exists && is_circle( complex_circle ) ) ? complex_circle.area() : 0 ;
      ...
      HTMLcode += "<table>" ;
      HTMLcode += "<tr>" ;
      HTMLcode += "<td "+( ( !_b_exists || bISNULL ) ? "CLASS=\"linkdead\"" : "CLASS=\"link_rounded\" ONCLICK=\"javascript:CIRCLESmarklimitset("+_index+", _glob_zplane_rendering_layer_pointer );\"" )+">Mark fixed points</td>" ;
      HTMLcode += "<td WIDTH=\"10\"></td>" ;
