function CIRCLESformsCOORDINATES_REMOTE_CTRL_KEYWORDS_INIT()
{

}

function CIRCLESformsCOORDINATESremotectrl( _options, _return_fn, _ret_array, _output_channel )
{
	...
	switch( _options[0].toLowerCase() )
	{
        ...
        var _sub = "forms", _base_id = "coordinates" ;
