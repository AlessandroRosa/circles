function CIRCLESembeddingsMIRRORQUASIFUCHSIAN_TOGGLE_PREVIEW()
{
		$( "#PLUGIN_PREVIEW" ).toggle( "slow",
																	 function()
																	 {
																	 		CIRCLESembeddingsMIRRORQUASIFUCHSIAN_RENDER_PREVIEW( "MIRRORQUASIFUCHSIAN", Z_PLANE );
...
function CIRCLESembeddingsMIRRORQUASIFUCHSIAN_RENDER_PREVIEW( _base_id, _plane_type )
{
