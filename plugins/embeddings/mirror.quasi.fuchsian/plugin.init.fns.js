    ...
    switch( _opcode )
    {
        ...
        if ( _chunk != null )
        {
            ...
            if( $( "#CIRCLESembeddingsMIRRORQUASIFUCHSIAN_CANVAS" ).is( ":visible" ) )
            {
                ...
                if ( typeof _fn === "function" ) _fn.call( this, "mirror.quasi.fuchsian", "embeddings", Z_PLANE ) ;
            }
...
function CIRCLESembeddingsMIRRORQUASIFUCHSIAN_OUTPUT( MM_01, MM_02, _init )
{
    ...
    if ( _init )
    {
        ...
        if ( _ret_id == RET_OK )
        {
            ...
            $("#PLUGIN_CONTAINER_PARAMS").html( GLOB_PLUGIN_GENS_TABLE_SHOW('mirror.quasi.fuchsian') );
...
function CIRCLESembeddingsMIRRORQUASIFUCHSIAN_PARSE( _tau_formula )
{
    ...
    if ( _plugin_tmp_vars_array['embeddings@mirrorquasifuchsian'] == null ) _plugin_tmp_vars_array['embeddings@mirrorquasifuchsian'] = [] ;
    _plugin_tmp_vars_array['embeddings@mirrorquasifuchsian']['tau'] = CIRCLESembeddingsMIRRORQUASIFUCHSIAN_tau ;

    _plugin_tmp_vars_array['tau'] = CIRCLESembeddingsMIRRORQUASIFUCHSIAN_tau ;
