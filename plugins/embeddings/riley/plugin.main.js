function CIRCLESembeddingsRILEYclose() { circles_lib_plugin_dispatcher_unicast_message( "riley", "embeddings", POPUP_DISPATCHER_UNICAST_EVENT_CLOSE ); }
function CIRCLESembeddingsRILEY_EVENTS( ctrl_id, event )
{
	  ...
	  if ( event.cancelBubble != null ) event.cancelBubble = true;
		...
		switch( event.keyCode )
		{
           ...
           {
              if ( _plugin_step_index == 1.1 ) CIRCLESembeddingsRILEY_RECORD_PARAMS();
...
function CIRCLESembeddingsRILEY_PARAMS_FILL()
{
    ...
    if ( arguments[0] != null )
    {
        ...
        $( "#PLUGIN_PARAM_RHO" ).val( _a.formula() );
        _entries++ ;
    }
...
function CIRCLESembeddingsRILEY_CONFIG( _base_id )
{
    ...
    _plugin_definitions_array[_index_ref] = "Riley slice" ;
    ...
    _plugin_init_fns_array[_index_ref] = "CIRCLESembeddingsRILEY_CONFIG" ;
...
function CIRCLESembeddingsRILEY_RECORD_PARAMS()
{
...
function CIRCLESembeddingsRILEYmain( _base_id, _move, _restore )
{
    ...
    var _this_fn_name = "CIRCLESembeddingsRILEYmain" + "(NO,"+_restore+")" ;
    ...
    HTMLcode += circles_lib_plugin_caption_code( YES, _glob_submethod_desc, 1, YES, CLOSE_FN,
                WIDTH, HEIGHT, _this_fn_name, 'riley', _div_id, _subset, "plug/plug.icon.01.20x20.png", "", "", "CIRCLES"+_subset+"RILEY_",
    ...
    circles_lib_plugin_activate( NO, _base_id, _this_fn_name, arguments, 'embeddings', OPEN, _div.id, _glob_submethod_desc, [ "CIRCLESembeddingsRILEY_NORMALIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsRILEY_MINIMIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsRILEY_MAXIMIZE", _div_id ] );
    if ( _move && _div != null )
		{
				if ( is_string( _move ) )
				{
