function CIRCLESembeddingsEARLE_TOGGLE_PREVIEW()
{
		$( "#PLUGIN_PREVIEW" ).toggle( "slow",
			 function()
			 {
					CIRCLESembeddingsEARLE_RENDER_PREVIEW( "EARLE", Z_PLANE );
...
function CIRCLESembeddingsEARLE_RENDER_PREVIEW( _base_id, _plane_type )
{
