...
function CIRCLESembeddingsGRANDMAPARABOLICremotectrl( _options, _return_fn, _ret_array, _out_channel )
{
    ...
    var _div_id = _idx != UNFOUND ? _glob_popups_array[_idx][1] : "" ;
        ...
        return 1 ;
				break ;
				case "info.params":
        _ret_array.push( 1, "<green>Param identifiers for the Earle plugin: 'a', 'b'</green> and 'p' for the solutions selector" ) ;
				break ;
				case "update.params":
