function CIRCLESembeddingsGRANDMAPARABOLICclose() { return circles_lib_plugin_dispatcher_unicast_message( 'grandma.parabolic', "embeddings", POPUP_DISPATCHER_UNICAST_EVENT_CLOSE ); }
...
{
    if ( CIRCLESembeddingsGRANDMAPARABOLIC_param != 0 ) circles_lib_plugin_load('forms','method', YES, 1, _glob_method, fn );
