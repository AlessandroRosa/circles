function CIRCLESembeddingsGRANDMAPARABOLIC_TOGGLE_PREVIEW()
{
		$( "#PLUGIN_PREVIEW" ).toggle( "slow",
																	 function()
																	 {
																	 		CIRCLESembeddingsGRANDMAPARABOLIC_RENDER_PREVIEW( "GRANDMAPARABOLIC", Z_PLANE );
...
function CIRCLESembeddingsGRANDMAPARABOLIC_RENDER_PREVIEW( _base_id, _plane_type )
{
