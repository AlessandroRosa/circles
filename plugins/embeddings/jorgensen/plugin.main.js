function CIRCLESembeddingsJORGENSENclose() { return circles_lib_plugin_dispatcher_unicast_message( 'jorgensen', "embeddings", POPUP_DISPATCHER_UNICAST_EVENT_CLOSE ); }
...
function CIRCLESembeddingsJORGENSEN_CONFIG( _base_id )
{
    ...
    _plugin_init_fns_array[_index_ref] = "CIRCLESembeddingsJORGENSEN_CONFIG" ;
...
function CIRCLESembeddingsJORGENSENmain( _base_id, _move, _restore )
{
    ...
    var _this_fn_name = "CIRCLESembeddingsJORGENSENmain" + "(NO,"+_restore+")" ;
    ...
    HTMLcode += circles_lib_plugin_caption_code( YES, _glob_submethod_desc, 1, YES, CLOSE_FN, WIDTH, HEIGHT,
                _this_fn_name, 'jorgensen', _div_id, _subset, "plug/plug.icon.01.20x20.png", "", "", "CIRCLES"+_subset+"JORGENSEN_",
    ...
    circles_lib_plugin_activate( NO, _base_id, _this_fn_name, arguments, 'embeddings', OPEN, _div.id, _glob_submethod_desc, [ "CIRCLESembeddingsJORGENSEN_NORMALIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsJORGENSEN_MINIMIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsJORGENSEN_MAXIMIZE", _div_id ] );
    if ( _move && _div != null )
	{
		if ( is_string( _move ) )
		{
