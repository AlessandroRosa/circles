...
function CIRCLESembeddingsMASKITTWICEmain( _base_id, _move, _restore )
{
    ...
    HTMLcode += circles_lib_popup_caption_code( YES, _glob_submethod_desc, 1, YES, "GLOB_PLUGIN_DESTROY_POPUP_VARS();", WIDTH, HEIGHT, this_fn_name, 'maskit.twice', _div_id, 'embeddings', "plug/plug.icon.01.16x16.png", "", "", "CIRCLESembeddingsMASKITTWICE_",
