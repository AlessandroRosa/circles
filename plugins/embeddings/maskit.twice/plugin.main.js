...
function CIRCLESembeddingsMASKITTWICEmain( _base_id, _move, _restore )
{
    ...
    circles_lib_plugin_activate( NO, _base_id, arguments.callee.name, arguments, 'embeddings', OPEN, _div.id, _glob_submethod_desc, [ "CIRCLESembeddingsMASKITTWICE_NORMALIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsMASKITTWICE_MINIMIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsMASKITTWICE_MAXIMIZE", _div_id ] );
    if ( _move && _div != null )
		{
				if ( is_string( _move ) )
				{
