function CIRCLESembeddingsMASKITTWICEclose() { circles_lib_plugin_dispatcher_unicast_message( "maskit.twice", "embeddings", POPUP_DISPATCHER_UNICAST_EVENT_CLOSE ); }
	  ...
	  if ( event.cancelBubble != null ) event.cancelBubble = true;
		...
		switch( event.keyCode )
		{
             ...
             else if ( ctrl_id.strcmp( "PLUGIN_PARAM_TAU_2" ) )
             {
				 ...
				 {
					  if ( _plugin_step_index == 1.1 ) CIRCLESembeddingsMASKITTWICE_RECORD_PARAMS();
...
function CIRCLESembeddingsMASKITTWICE_CONFIG( _base_id )
{
    ...
    _plugin_init_fns_array[_index_ref] = "CIRCLESembeddingsMASKITTWICE_CONFIG" ;
...
function CIRCLESembeddingsMASKITTWICE_RECORD_PARAMS()
{
...
function CIRCLESembeddingsMASKITTWICEmain( _base_id, _move, _restore )
{
    ...
    var _this_fn_name = "CIRCLESembeddingsMASKITTWICEmain" + "(NO,"+_restore+")" ;
    ...
    HTMLcode += circles_lib_plugin_caption_code( YES, _glob_submethod_desc, 1, YES, CLOSE_FN,
                WIDTH, HEIGHT, _this_fn_name, 'maskit.twice', _div_id, _subset, "plug/plug.icon.01.20x20.png", "", "", "CIRCLES"+_subset+"MASKITTWICE_",
    ...
    circles_lib_plugin_activate( NO, _base_id, _this_fn_name, arguments, 'embeddings', OPEN, _div.id, _glob_submethod_desc, [ "CIRCLESembeddingsMASKITTWICE_NORMALIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsMASKITTWICE_MINIMIZE", _div_id, WIDTH, HEIGHT ], [ "CIRCLESembeddingsMASKITTWICE_MAXIMIZE", _div_id ] );
    if ( _move && _div != null )
		{
				if ( is_string( _move ) )
				{
