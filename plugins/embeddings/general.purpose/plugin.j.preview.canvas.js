function CIRCLESembeddingsGENERALPURPOSE_TOGGLE_PREVIEW()
{
    $( "#PLUGIN_PREVIEW" ).toggle( "slow", function()
    {
      circles_lib_plugin_render_preview( "general.purpose", "embeddings", Z_PLANE );
      ...
      if ( _visible )
      {
        ...
        CIRCLESembeddingsEARLE_PRESETS(2,YES);
    	}
    }