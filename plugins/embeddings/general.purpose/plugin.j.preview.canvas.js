function CIRCLESembeddingsGENERALPURPOSE_TOGGLE_PREVIEW() { $( "#PLUGIN_PREVIEW" ).toggle( "slow", function() { CIRCLESembeddingsGENERALPURPOSE_RENDER_PREVIEW( "GENERALPURPOSE", Z_PLANE ); $( "#PLUGIN_TOGGLE_PREVIEW_BTN" ).html( $( "#PLUGIN_PREVIEW" ).is(":visible") ? "Hide preview" : "Show preview" ); } ); }
