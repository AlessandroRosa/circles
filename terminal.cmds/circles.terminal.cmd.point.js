function circles_terminal_cmd_point()
{
     ...
     if ( _params.length > 0 )
     {
         ...
         _params_array.clean_from( " " ); _params_array.clean_from( "" ); 
    		 ...
    		 var _cmd_terms_dict = [];
    				 _cmd_terms_dict.push( "fill", "draw", "rec", "zplane", "wplane", "bip",
        ...
        _cmd_params['storagesubset'] = "circles" ;
         ...
         else if ( !_b_fail )
         {
             ...
             switch( _action )
             {
                 ...
                 else if ( _cmd_params['plane'] == NO_PLANE ) { _b_fail = YES, _error_str = "Fail to plot point: missing plane reference" ; }
                ...
                // switch to different constructors, according to input data
                  for( var _i = 0 ; _i < _cmd_params['pt'].length ; _i++ )
                  {
                      ...
                      else { _b_fail = YES, _error_str = "Fail to plot point: memory failure. Free some resources" ; break ; }
                  }
                 break ;
             }
         }
