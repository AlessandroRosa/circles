function circles_terminal_cmd_keepcmd()
{
    ...
    if ( _params.length > 0 )
    {
         ...
         _cmd_params['settings']['expression'] = [] ;

         var _params_array = _params.includes( " " ) ? _params.split( " " ) : [ _params ] ;
         _params_array.clean_from( " " ); _params_array.clean_from( "" ); 
         // pre-scan for levenshtein correction
    		 var _local_cmds_params_array = [];
    				 _local_cmds_params_array.push( "off", "release", "html" );
         ...
         for( var _i = 0 ; _i < _params_array.length ; _i++ )
         {
            ...
            else if ( _p.length > 0 ) _cmd_params['settings']['expression'].push( _p ) ;
         }
         ...
         {
             var _expr = _cmd_params['settings']['expression'] ;
             ...
             switch( _action )
             {
                  ...
                  break ;
                  case "keep":
                  var _expression = _cmd_params['settings']['expression'].length > 0 ? _cmd_params['settings']['expression'].join( " " ) : "" ;
