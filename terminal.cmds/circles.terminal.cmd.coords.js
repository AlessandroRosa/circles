    ...
    else if ( _params.length > 0 )
    {
        ...
        else if ( !_b_fail )
        {
            ...
            switch( _action )
            {
                ...
                else if ( _params_assoc_array['center'] || _params_assoc_array['all'] )
                {
                ...
                for( var _pl = 0 ; _pl < _params_assoc_array['planes'].length ; _pl++ )
                {
                    if ( _params_assoc_array['planes'][_pl] != NO_PLANE )
                    {
                      ...
                      circles_lib_output( _output_channel, DISPATCH_MULTICOLOR, "<yellow>"+_MSG+"</yellow>", _par_1, _cmd_tag );
             ...
             if ( _render )
             {
                ...
                else circles_lib_output( _output_channel, DISPATCH_WARNING, "Rendering has been skipped: no registered seeds or generators", _par_1, _cmd_tag );
             }
        }
    }
