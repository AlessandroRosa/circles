function circles_terminal_cmd_export()
{
    ...
    for( var _i = 0 ; _i < _params_array.length ; _i++ )
    {
        ...
        if ( _p.is_one_of_i( "/h", "/help", "--help", "/?" ) ) _cmd_params['help'] = _help = YES ;
        ...
        else if ( _p.stricmp( "pdf" ) ) _cmd_params['format'] = EXPORT_PDF ;
        else if ( _p.stricmp( "png" ) ) _cmd_params['format'] = EXPORT_PNG ;
         ...
         else
         {
             ...
             switch( _action )
             {
                  ...
                  var _format_str = "" ;
				  console.log( _glob_export_format );
                  switch( _glob_export_format )
                  {
                       ...
                       case EXPORT_PDF:
                       _b_fail = 0 ;
                       _format_str = "Export to PDF file format" ;
                       break ;
                       case EXPORT_PS:
                       _b_fail = 0 ;
                       ...
                       case EXPORT_PNG:
                       _b_fail = 0 ;
                       _format_str = "Export to PNG file format" ;
                       break ;
                       case EXPORT_NONE:
                       _b_fail = 0 ;
