function circles_terminal_cmd_dump()
{
     ...
     if ( _params.length > 0 )
     {
         ...
         else if ( !_b_fail )
         {
             ...
             switch( _action )
             {
                ...
                circles_lib_output( _out_channel, DISPATCH_INFO, "var '"+_dumping_obj+"' is empty", _par_1, _cmd_tag );
     ...
     if ( _b_fail && _glob_terminal_errors_switch && _out_channel != OUTPUT_FILE_INCLUSION ) circles_lib_output( _out_channel, DISPATCH_ERROR, $.terminal.escape_brackets( _error_str ), _par_1, _cmd_tag );
