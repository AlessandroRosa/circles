...
function circles_terminal_cmd_plane()
{
    ...
    if ( _params.length > 0 )
    {
    	...
    	var _cmd_terms_dict = [];
    	_cmd_terms_dict.push( "all", "bip", "wplane", "zplane", "none", "release", "html" );
        ...
        for( var _i = 0 ; _i < _params_array.length ; _i++ )
        {
            ...
            else if ( /bip[box]*/gi.test( _p ) ) _cmd_params['plane'] = BIP_BOX ;
            else if ( /z[\-]*plane/gi.test( _p ) ) _cmd_params['plane'] = _glob_target_plane = Z_PLANE ;
            else if ( /w[\-]*plane/gi.test( _p ) ) _cmd_params['plane'] = _glob_target_plane = W_PLANE ;
