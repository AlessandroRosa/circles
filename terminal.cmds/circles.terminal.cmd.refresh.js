                  ...
                  if ( _plane != NO_PLANE )
                  {
                       ...
                       switch( _plane )
                       {
                          ...
                          else
                          {
                              ...
                              if ( _layer_ref == "grid" )
                              {
                                  _ret_chunk = circles_lib_canvas_render_zplane( _glob_zplane_grid_layer_placeholder, zplane_sm, null, _clean, YES, _render, !_silent, _silent, YES, _output_channel );
                                  _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                  _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                                  circles_lib_output( _output_channel, _ret_id ? DISPATCH_SUCCESS : DISPATCH_ERROR, _ret_msg, _par_1, _cmd_tag );
                              }
                              ...
                              {
                                  _ret_chunk = circles_lib_canvas_render_zplane( _glob_zplane_freedraw_layer_placeholder, zplane_sm, null, _clean, YES, _render, !_silent, _silent, YES, _output_channel );
                                  _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                  _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                                  circles_lib_output( _output_channel, _ret_id ? DISPATCH_SUCCESS : DISPATCH_ERROR, _ret_msg, _par_1, _cmd_tag );
                              }
                              if ( _layer_ref == "work" )
                              {
                                  _ret_chunk = circles_lib_canvas_render_zplane( _glob_zplane_work_layer_placeholder, zplane_sm, null, _clean, YES, _render, !_silent, _silent, YES, _output_channel );
                                  _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                  _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                                  circles_lib_output( _output_channel, _ret_id ? DISPATCH_SUCCESS : DISPATCH_ERROR, _ret_msg, _par_1, _cmd_tag );
                              }
                          ...
                          else
                          {
                              ...
                              if ( _layer_ref == "grid" )
                              {
                                   _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_grid_layer_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _output_channel );
                                   _ret_id = is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                   _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                                   circles_lib_output( _output_channel, _ret_id ? DISPATCH_SUCCESS : DISPATCH_ERROR, _ret_msg, _par_1, _cmd_tag );
                              }
                              ...
                              if ( _layer_ref == "freedraw" )
                              {
                                   _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_freedraw_layer_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _output_channel );
                                   _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                   _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                                   circles_lib_output( _output_channel, _ret_id ? DISPATCH_SUCCESS : DISPATCH_ERROR, _ret_msg, _par_1, _cmd_tag );
                              }
                              ...
                              if ( _layer_ref == "work" )
                              {
                                   _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_work_layer_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _output_channel );
                                   _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                   _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                          ...
                          else
                          {
                              ...
                              if ( _layer_ref == "grid" )
                              {
                                  var _ret_chunk_zplane = circles_lib_canvas_render_zplane( _glob_zplane_grid_layer_placeholder, zplane_sm, null, _clean, YES, _render, !_silent, _silent, YES, _output_channel );
                                  if ( _ret_chunk_zplane[0] != RET_IRRELEVANT ) _final_ret &= _ret_chunk_zplane != null ? _ret_chunk_zplane[0] : 0 ;
                                  var _ret_chunk_wplane = circles_lib_canvas_render_wplane( _glob_wplane_grid_layer_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _output_channel );
                              ...
                              if ( _layer_ref == "freedraw" )
                              {
                                  var _ret_chunk = circles_lib_canvas_render_zplane( _glob_zplane_freedraw_layer_placeholder, zplane_sm, null, _clean, YES, _render, !_silent, _silent, YES, _output_channel );
                                  if ( _ret_chunk[0] != RET_IRRELEVANT ) _final_ret &= is_array( _ret_chunk ) ? _ret_chunk[0] : 0 ;
                                  var _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_freedraw_layer_placeholder, zplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _output_channel );
                                  if ( _ret_chunk[0] != RET_IRRELEVANT ) _final_ret &= is_array( _ret_chunk ) ? _ret_chunk[0] : 0 ;
                              }
    
                              if ( _layer_ref == "work" )
                              {
                                  var _ret_chunk_zplane = circles_lib_canvas_render_zplane( _glob_zplane_work_layer_placeholder, zplane_sm, null, _clean, YES, _render, !_silent, _silent, YES, _output_channel );
                                  if ( _ret_chunk_zplane[0] != RET_IRRELEVANT )
                                  _final_ret &= _ret_chunk_zplane != null ? _ret_chunk_zplane[0] : 0 ;
                                  var _ret_chunk_wplane = circles_lib_canvas_render_wplane( _glob_wplane_work_layer_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _output_channel );
                                  if ( _ret_chunk_wplane[0] != RET_IRRELEVANT )
