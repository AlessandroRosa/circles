function circles_terminal_cmd_grid()
{
     ...
     if ( _params.length > 0 )
     {
         ...
         for( var _i = 0 ; _i < _params_array.length ; _i++ )
         {
              ...
              else if ( _p.stricmp( "default" ) ) _cmd_params['default'] = YES ;
         ...
         else if ( !_b_fail )
         {
             ...
             else if ( _cmd_params['default'] != null )
             {
                  ...
                  circles_lib_output( _out_channel, DISPATCH_INFO, circles_lib_plane_def_get( W_PLANE )+"grid set to " + ( _glob_show_grid_zplane ? "visible" : "hidden" ), _par_1, _cmd_tag );
             ...
             if ( !_b_fail )
             {
                  ...
                  if ( _glob_terminal_autorefresh == ENABLED && _cmd_params['planeindex'].is_one_of( Z_PLANE, ALL_PLANES ) )
                  {
                  ...
                  if ( _glob_terminal_autorefresh == ENABLED && _cmd_params['planeindex'].is_one_of( W_PLANE, ALL_PLANES ) )
                  {
