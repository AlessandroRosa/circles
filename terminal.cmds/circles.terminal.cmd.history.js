function circles_terminal_cmd_history()
{
    ...
    else if ( _params.length > 0 )
    {
        ...
        for( var _i = 0 ; _i < _params_array.length ; _i++ )
        {
            ...
            else if ( _p.testME( _glob_integer_regex_pattern ) ) _cmd_params['entries'] = safe_int( _p, 1 );
     ...
     else
     {
         ...
         switch( _action )
         {
            ...
            break ;
            default:
			circles_lib_terminal_interpreter( "console history " + _cmd_params['entries'], _glob_terminal, _out_channel );
            break ;
         }
     }
