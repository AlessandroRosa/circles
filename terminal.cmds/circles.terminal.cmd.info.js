function circles_terminal_cmd_info()
{
    ...
    var _cmd_terms_dict = [ "show", "reset", "release", "seeds", "generators", "html", "group", "properties", "extras", "normalize" ];
    ...
    for( var _i = 0 ; _i < _max ; _i++ )
    {
        ...
        else if ( _p.is_one_of_i( "normalize" ) )
        {
         ...
         else if ( !_b_fail )
         {
             ...
             var _querying_gens = _cmd_params["item"] == ITEMS_SWITCH_GENS ? YES : NO ;
             ...
             switch( _action )
             {
                ...
                else
                {
                    ...
                    circles_lib_output( _out_channel, DISPATCH_MULTICOLOR, "The current group includes <lightblue>" + _sd_n + " generator" + ( _sd_n == 1 ? "" : "s" ), _par_1 ) + "</lightblue>";
