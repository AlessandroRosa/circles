function circles_terminal_cmd_srcptset()
{
     ...
     else if ( _params.length > 0 )
     {
         ...
         _cmd_params['start_pt'] = null ;
         _cmd_params['end_pt'] = null ;
         _cmd_params['width'] = null ;
         _cmd_params['height'] = null ;

         var _params_array = _params.includes( " " ) ? _params.split( " " ) : [ _params ] ;
         _params_array.clean_from( " " ); _params_array.clean_from( "" ); 
         // pre-scan for levenshtein correction
    		 var _cmd_terms_dict = [];
    				 _cmd_terms_dict.push( "init", "destroy", "ins", "del", "shape", "html", "release", "word" );
         ...
         for( var _i = 0 ; _i < _params_array.length ; _i++ )
         {
            ...
            else if ( _p.is_one_of_i( "zplane", "wplane" ) ) { _cmd_params['plane'] = _p ; _cmd_params['action'] = "plane" ; }
            else if ( _p.is_one_of_i( "ins", "config", "del", "destroy", "init", "plane", "run", "shape" ) ) _cmd_params['action'] = _p.toLowerCase() ;
            else if ( _p.is_one_of_i( "circle", "disk", "line", "rect" ) ) _cmd_params['shape'] = _p.toLowerCase() ;
            else if ( _p.testME( _glob_complex_number_regex_pattern ) )
            {
               switch( _cmd_params['shape'] )
               {
                 case "circle":
                 case "disk":
                 if ( _cmd_params['center'] == null ) _cmd_params['center'] = _p ;
                 else if ( _cmd_params['radius'] == null ) _cmd_params['radius'] = _p ;
                 break ;
                 case "rect":
                 if ( _cmd_params['center'] == null ) _cmd_params['center'] = _p ;
                 else if ( _cmd_params['width'] == null ) _cmd_params['width'] = _p ;
                 else if ( _cmd_params['height'] == null ) _cmd_params['height'] = _p ;
                 break ;
                 case "line":
                 if ( _cmd_params['start_pt'] == null ) _cmd_params['start_pt'] = _p ;
                 else if ( _cmd_params['end_pt'] == null ) _cmd_params['end_pt'] = _p ;
                 break ;
                 default: break ;
               }
            }
            ...
            {
               _cmd_params['action'] = "word" ;
               _cmd_params['word'] = _p.replaceAll( "word:", "" ) ;
            }
         ...
         else
         {
             ...
             switch( _action )
             {
               ...
               case "del":
               if ( _glob_storage['srcptset'] == null )
               circles_lib_output( _out_channel, DISPATCH_ERROR, "Please, init the source points set to perform point deletion", _par_1, _cmd_tag );
               else if ( _cmd_params['complex'].length == 0 )
               circles_lib_output( _out_channel, DISPATCH_ERROR, "Please, missing input complex point for point deletion", _par_1, _cmd_tag );
               else
               {
                 var _c = parse_complex_from_string( _cmd_params['complex'] ) ;
                 if ( is_complex( _c ) )
                 {
                   _c = _c.formula() ;
                   ...
                   if ( _glob_storage['srcptset']['pts'].includes( _c ) )
                   {
                     ...
                     circles_lib_output( _out_channel, DISPATCH_SUCCESS, "The complex value "+_cmd_params['complex']+" has been successfully deleted.", _par_1, _cmd_tag );
                     else
                     circles_lib_output( _out_channel, DISPATCH_ERROR, "The complex value "+_cmd_params['complex']+" has not been deleted.", _par_1, _cmd_tag );
                   }
                 }
                 else
                 {
                   circles_lib_output( _out_channel, DISPATCH_ERROR, "Cannot perform point deletion: the input parameter '"+_cmd_params['complex']+"' is not a valid complex number", _par_1, _cmd_tag );
                 }
               }
               break ;
               case "destroy":
               if ( _glob_storage['srcptset'] == null )
               circles_lib_output( _out_channel, DISPATCH_WARNING, "Cannot '"+_action+"' the source points set, because no initialization has been made yet.", _par_1, _cmd_tag );
               else
               {
               ...
               case "ins":
               if ( _glob_storage['srcptset'] == null )
               circles_lib_output( _out_channel, DISPATCH_ERROR, "Please, init the source points set to perform point insertion", _par_1, _cmd_tag );
               else if ( _cmd_params['complex'].length == 0 )
               circles_lib_output( _out_channel, DISPATCH_ERROR, "Please, missing input complex point for point insertion", _par_1, _cmd_tag );
               else
               {
                 var _c = parse_complex_from_string( _cmd_params['complex'] ) ;
                 if ( is_complex( _c ) )
                 {
                   ...
                   if ( _glob_storage['srcptset']['pts'].not_includes( _c ) )
                   {
                     ...
                     if ( _glob_storage['srcptset']['pts'].length == _len + 1 )
                     circles_lib_output( _out_channel, DISPATCH_SUCCESS, "The complex value "+_cmd_params['complex']+" has been successfully added.", _par_1, _cmd_tag );
                     else
                     circles_lib_output( _out_channel, DISPATCH_ERROR, "The complex value "+_cmd_params['complex']+" has not been added.", _par_1, _cmd_tag );
                   }
                 }
                 else
                 {
                   circles_lib_output( _out_channel, DISPATCH_ERROR, "Cannot perform point insertion: the input parameter '"+_cmd_params['complex']+"' is not a valid complex number", _par_1, _cmd_tag );
                 }
               }
               break ;
               case "init":
               ...
               break ;
               case "plane":
               var _plane = _cmd_params['plane'], _plane_def = circles_lib_return_plane_type( _plane ) ;
               if ( _glob_storage['srcptset'] == null )
               ...
               circles_lib_output( _out_channel, DISPATCH_WARNING, "Invalid input plane", _par_1, _cmd_tag );
               else
               {
               ...
               break ;
               case "shape":
               var _shape = _cmd_params['shape'] ;
               if ( _glob_storage['srcptset'] == null )
               circles_lib_output( _out_channel, DISPATCH_WARNING, "Cannot set the shape '"+_shape+"', because no initialization has been made.", _par_1, _cmd_tag );
               else
               {
                 ...
                 switch( _shape )
                 {
                    case "circle":
                    case "disk":
                    _glob_storage['srcptset']['center'] = _cmd_params['center'] ;
                    _glob_storage['srcptset']['radius'] = _cmd_params['radius'] ;
                    break ;
                    case "line":
                    _glob_storage['srcptset']['start_pt'] = _cmd_params['start_pt'] ;
                    _glob_storage['srcptset']['end_pt'] = _cmd_params['end_pt'] ;
                    break ;
                    case "rect":
                    _glob_storage['srcptset']['center'] = _cmd_params['center'] ;
                    _glob_storage['srcptset']['width'] = _cmd_params['width'] ;
                    _glob_storage['srcptset']['height'] = _cmd_params['height'] ;
                    break ;
                    default: break ;
                 }
               ...
               break ;
               case "word":
               var _input_word = _cmd_params['word'] ;
               if ( _glob_storage['srcptset'] == null )
               circles_lib_output( _out_channel, DISPATCH_WARNING, "Cannot set up the word, because no initialization has been made.", _par_1, _cmd_tag );
               else
               {
