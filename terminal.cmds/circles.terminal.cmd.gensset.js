function circles_terminal_cmd_gensset()
{
     ...
     else if ( _params.length > 0 )
     {
         ...
         for( var _i = 0 ; _i < _up_to_index ; _i++ )
         {
            ...
            else if ( _p.stricmp( "force" ) ) _cmd_params['force'] = YES ;
            ...
            {
               if ( _cmd_params['action'].stricmp( "add" ) )
               {
                   var _gen_symbol = _p.trim();
                   if ( _cmd_params['inverse'] ) _gen_symbol = circles_lib_word_inverse_get( _gen_symbol );
                   ...
                   else
                   {
					   ...
					   _cmd_params['gens'].push( _gen_symbol );
					}
         ...
         else if ( !_b_fail )
         {
            ...
            switch( _action )
            {
                            ...
                            if ( is_array( _mobius_params_array ) && !_b_fail )
                            {
                              if ( safe_size( _mobius_params_array, 0 ) == 4 )
                              {
                                ...
                                else
                                {
                                  ...
                                  var _array_ref = _cmd_params["item"] == ITEMS_SWITCH_GENS ? _glob_gens_array : _glob_seeds_array ;
                                  var _dest_ref = _cmd_params["item"] == ITEMS_SWITCH_SEEDS ? "seeds" : "generators set" ;
               ...
               {
                    var _ret_chunk = circles_lib_gens_set_build( _out_channel, YES, _cmd_params['force'], NO, YES );
     ...
     if ( _glob_gens_set_to_init && !_cmd_params['action'].is_one_of_i( "bomb" ) )
     {
