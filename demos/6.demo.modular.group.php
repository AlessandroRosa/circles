...
var _demon = new demo_n();
    ...
    _demon.add( { pre_fn : function()
                  {
                     ...
                     $( "#presentation_div" ).html( "CIRCLES DEMO #6<br>Plotting the Modular Group" ) ;
                  },
    ...
    _demon.add( { pre_fn : function() { $( "#presentation_div" ).html( "END OF DEMO #6<br>Forget the Past, forgive the Present" ) ; },
                  ctrl_id : "presentation_div", time : 2, time_unit : "s",
