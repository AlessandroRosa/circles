...
var _demon = new demo_n();
    ...
    _demon.add( { pre_fn : function()
                  {
                     ...
                     $( "#presentation_div" ).html( "CIRCLES DEMO #8\nWorking with the discreteness locus\nfor Maskit embedding T1,1" ) ;
    ...
    _demon.add( { post_fn : function() { _glob_terminal.exec( "depth 16" ); },
                  ctrl_id : "MENU_MAIN_EXTRAS", time : 2.0, time_unit : "s",
                  action : "nothing", set_value : -1, showlabel : false, desclabel : "" } );
    ...
    _demon.add( { post_fn : function() { _glob_terminal.exec( "plugin send get.point 0.09+1.85i" ); },
                  ctrl_id : "PLUGIN_PARAM_MU", time : 2.0, time_unit : "s",
    ...
    _demon.add( { post_fn : function() { _glob_terminal.exec( "plugin send move left bottom" ); },
                  ctrl_id : "MENU_MAIN_EXTRAS", time : 2.0, time_unit : "s",
                  action : "nothing", set_value : -1, showlabel : false, desclabel : "" } );
