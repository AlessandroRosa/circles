...
var _demon = new demo_n();
    ...
    _demon.add( { pre_fn : function()
                  {
                    ...
                    $( "#presentation_div" ).html( "CIRCLES DEMO #<?php echo $GLOBALS["DEMO_IDX"]; ?><br>An example of Sasaki group<br>via 'General Purpose' mask" ) ;
                  },
    ...
    _demon.add( { pre_fn : function()
                  {
                    $( "#presentation_div" ).css( "background-color", "#538BB4" ) ;
                    var _html = "END OF DEMO #<?php echo $DEMO_IDX ; ?><br>be grateful to life !" ;
