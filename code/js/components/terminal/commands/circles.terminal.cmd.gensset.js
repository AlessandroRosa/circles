            ...
            switch( _action )
            {
               ...
               else
               {
                      ...
                      if ( _n_gens > 0 )
                      {
                          ...
                          if ( circles_lib_popup_is_visible( "method" ) ) circles_lib_popup_dispatcher_unicast_message( 'method', 'forms', 3.21 ) ;
            ...
            if ( _params_assoc_array['rec'] || _params_assoc_array["copy"] )
            {
                ...
                if ( _items_array.length > 0 )
                {
                   ...
                   for( var _i = 0 ; _i < _items_array.length ; _i++ )
                   {
                       ...
                       _rec_chunk['drawcolor'] = _items_array[_i].complex_circle.drawcolor ;
