function circles_terminal_cmd_doctor()
{
     ...
     {
         var _msg = "Doctor's scan can't start: " + _ERR_33_01 ;
...
function _doctor_scan_init_options( _items_array, _out_channel, _par_1, _src )
{
     ...
     {
        _error_counter++ ;
        circles_lib_output( _out_channel, DISPATCH_WARNING, "No selected method. Init options scan quits", _par_1, _src );
        return [ _error_scan, _error_counter ] ;
     }
     else
     {
        var _method_def = circles_lib_method_get_def( _glob_method );
        var _process_def = circles_lib_process_get_def( _glob_process );
...
function _doctor_scan_items_integrity( _items_array, _out_channel, _par_1, _src )
{
     ...
     if ( _items_n != _n_items_safe )
     {
         ...
         circles_lib_output( _out_channel, DISPATCH_WARNING, "Detected possible memory leak in items archive", _par_1, _src );
        ...
        else
        {
            ...
            */
                      ...
                      ITEM.complex_circle.fillcolor.length == 0 && !_glob_palette_use )
            {
                ...
                circles_lib_output( _out_channel, DISPATCH_WARNING, "Draw color reset to 'black'. Fill color, if required, could be manually set", _par_1, _src );
