               ...
               else
               {
                 ...
                 if ( is_complex( _c ) )
                 {
                   ...
                   if ( _glob_storage['srcptset']['pts'].includes( _c ) )
                   {
                     ...
                     circles_lib_output( _out_channel, DISPATCH_SUCCESS, "The complex value "+_params_assoc_array['complex']+" has been successfully deleted.", _par_1, _cmd_tag );
                     else
                     circles_lib_output( _out_channel, DISPATCH_ERROR, "The complex value "+_params_assoc_array['complex']+" has not been deleted.", _par_1, _cmd_tag );
                   }
                 }
                 else
                 {
                   circles_lib_output( _out_channel, DISPATCH_ERROR, "Cannot perform point deletion: the input parameter '"+_params_assoc_array['complex']+"' is not a valid complex number", _par_1, _cmd_tag );
                 }
               }
               break ;
               case "destroy":
               ...
               else
               {
                 ...
                 if ( is_complex( _c ) )
                 {
                   ...
                   if ( _glob_storage['srcptset']['pts'].not_includes( _c ) )
                   {
                     ...
                     circles_lib_output( _out_channel, DISPATCH_ERROR, "The complex value "+_params_assoc_array['complex']+" has not been added.", _par_1, _cmd_tag );
                   }
                 }
                 else
                 {
                   circles_lib_output( _out_channel, DISPATCH_ERROR, "Cannot perform point insertion: the input parameter '"+_params_assoc_array['complex']+"' is not a valid complex number", _par_1, _cmd_tag );
                 }
               }
               break ;
               case "init":
