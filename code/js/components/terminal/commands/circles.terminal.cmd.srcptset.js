function circles_terminal_cmd_srcptset()
{
     ...
     else if ( _params.length > 0 )
     {
         ...
         for( var _i = 0 ; _i < _params_array.length ; _i++ )
         {
            ...
            else if ( _p.is_one_of_i( "add", "config", "del", "destroy", "init", "plane", "run", "shape" ) ) _params_assoc_array['action'] = _p.toLowerCase() ;
         ...
         else
         {
             ...
             switch( _action )
             {
               ...
               circles_lib_output( _out_channel, DISPATCH_ERROR, "Please, init the source points set to perform the action '"+_action+"'", _par_1, _cmd_tag );
               ...
               else circles_lib_output( _out_channel, DISPATCH_WARNING, "Source points set has not been initialized.", _par_1, _cmd_tag );
               break ;
               case "init":
               if ( _glob_storage['srcptset'] == null )
               {
