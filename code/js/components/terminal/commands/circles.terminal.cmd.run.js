     ...
     var _params_assoc_array = [];
         ...
         else if ( !_b_fail )
         {
             ...
             switch( _action )
             {
                 ...
                 break ;
                 default:
                 if ( _glob_terminal != null && _out_channel == OUTPUT_TERMINAL && _params_assoc_array['help'] != YES )
                 {
                           ...
                           circles_lib_batch_compiler_run();
        							...
        							else circles_lib_output( _out_channel, DISPATCH_WARNING, "No code to run", _par_1, _cmd_tag );         
                 }
                 break ;
             }
         }
