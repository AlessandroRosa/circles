              		...
              		if ( _current_method == METHOD_NONE )
               		{
      		           ...
      		           if ( _params_assoc_array['reset'] != null || ( _current_method == METHOD_NONE && _pr == PROCESS_NONE ) )
      		           {
      		               ...
      		               {
      		                   _current_method = METHOD_NONE, _pr = PROCESS_NONE ;
      		               }
      		               circles_lib_process_set( _pr ), circles_lib_method_set( _current_method ) ;
      		           }
      		           else if ( _current_method != METHOD_ALGEBRAIC && _pr != PROCESS_NONE )
      		           {
      		               _b_fail = YES, _error_str = "Current method and input process are not coherent" ;
      		           ...
      		           else if ( _current_method.is_one_of( METHOD_INVERSION, METHOD_NONE ) )
      		           {
      		               ...
      		               _b_fail = YES, _error_str = "Current method is set to 'Inversion'" ;
      		               _error_str += _glob_crlf + "Therefore no process has to be chosen and it will be set to 'none'" ;
      		           }
