     ...
     if ( _params.length > 0 )
     {
         ...
         else if ( !_b_fail )
         {
             ...
             switch( _action )
             {
                  ...
                  if ( _sd_n == 0 )
                  {
                       _b_fail = YES, _error_str = "Missing input gens or symbols" ;
                  }
                  ...
                  {
                       _b_fail = YES, _error_str = "Missing 'FROM' group of symbols" ;
                  }
                  else if ( _change_out_len == 0 )
                  {
                       _b_fail = YES, _error_str = "Missing 'TO' group of symbols" ;
                  }
                  else
                  {
                       ...
                       {
                            _b_fail = YES, _error_str = _err_report.join( _glob_crlf );
                       }
                       else
                       {
           ...
           break ;
                  ...
                  if ( _sd_n > 0 )
                  {
                       ...
                       var _counter = _out_array.length ;
                       var _out = "" ;
                  ...
                  {
                       _b_fail = YES, _error_str = "Parameters crash: can't declare both forward and backward direction" ;
                  }
                  else
                  {
