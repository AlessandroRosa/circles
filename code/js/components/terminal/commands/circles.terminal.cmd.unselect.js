     ...
     if ( _params.length > 0 )
     {
         ...
         // pre-scan for levenshtein correction
    		 var _local_cmds_params_array = [];
    				 _local_cmds_params_array.push( "zplane", "release", "html", "help" );
             ...
             switch( _action )
             {
                  ...
                  default:
                   ...
                   else
                   {
                        ...
                        {
                            _plane_str = is_array( _params_assoc_array ) ? _params_assoc_array['plane'] : "zplane" ;
                        ...
                        {
                            circles_lib_terminal_interpreter( "refresh "+_plane_str, _glob_terminal, _out_channel );
                            circles_lib_output( _out_channel, DISPATCH_SUCCESS, "Unselection is done", _par_1, _cmd_tag );
                        }
                   }
                  break ;
             }
