function circles_terminal_cmd_echo()
{
     ...
     else if ( !_help )
     {
         ...
         if ( _params.length > 0 ) circles_lib_output( _out_channel, DISPATCH_SUCCESS, _echo_label, _par_1, _cmd_tag );
         else circles_lib_output( _out_channel, DISPATCH_INFO, _echo_label );
     }
