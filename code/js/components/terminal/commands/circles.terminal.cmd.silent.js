     ...
     if ( _params.length > 0 )
     {
         ...
         else if ( !_b_fail )
         {
             ...
             switch( _action )
             {
                 ...
                 if ( _params.length > 0 )
                 circles_lib_output( _out_channel, _already ? DISPATCH_INFO : DISPATCH_SUCCESS, _silent_label, _par_1, _cmd_tag );
                 else 
                 circles_lib_output( _out_channel, DISPATCH_INFO, _silent_label, _par_1, _cmd_tag );
