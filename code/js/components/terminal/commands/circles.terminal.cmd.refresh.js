                  ...
                  if ( _plane != NO_PLANE )
                  {
                       ...
                       switch( _plane )
                       {
                          ...
                          else
                          {
                              ...
                              if ( _layer_ref == "grid" )
                              {
                                   _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_grid_canvas_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _out_channel );
                                   _ret_id = is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                   _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                                   circles_lib_output( _out_channel, _ret_id ? DISPATCH_SUCCESS : DISPATCH_ERROR, _ret_msg, _par_1, _cmd_tag );
                              }
                              ...
                              if ( _layer_ref == "rendering" )
                              {
                                   _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_rendering_canvas_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _out_channel );
                                   _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                   _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                              ...
                              if ( _layer_ref == "freedraw" )
                              {
                                   _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_freedraw_canvas_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _out_channel );
                                   _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                   _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
                                   circles_lib_output( _out_channel, _ret_id ? DISPATCH_SUCCESS : DISPATCH_ERROR, _ret_msg, _par_1, _cmd_tag );
                              }
                              ...
                              if ( _layer_ref == "work" )
                              {
                                   _ret_chunk = circles_lib_canvas_render_wplane( _glob_wplane_work_canvas_placeholder, wplane_sm, null, _clean, YES, _render, YES, !_silent, _silent, _out_channel );
                                   _ret_id &= is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
                                   _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
