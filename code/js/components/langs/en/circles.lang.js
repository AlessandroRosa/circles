...
var _ERR_00_03 = "Run-time error."+_glob_crlf+"Please, reload this page." ;
...
var _ERR_00_06 = "Fail to perform SHIFTING."+_glob_crlf.repeat(2)+"Selection is empty" ;
var _ERR_00_07 = "Fail to perform ROTATION."+_glob_crlf.repeat(2)+"The input shifting values are both zero" ;
var _ERR_00_08 = "Fail to perform ROTATION. No elements selected" ;
var _ERR_00_09 = "Fail to perform ROTATION."+_glob_crlf.repeat(2)+"The angle value is zero" ;
var _ERR_00_10 = "Fail to perform this operation: " + _ERR_33_01 ;
var _ERR_16_00 = "Fail to view isometric circles: " + _ERR_33_03 ;
var _ERR_17_00 = "Database is corrupted: symbol and its inverse are the same."+_glob_crlf.repeat(2)+"Set correct symbols or click the 'Suggest' button" ;
var _ERR_17_01 = "Database is corrupted: symbol and its inverse are the same."+_glob_crlf.repeat(2)+"Reload this page" ;
...
var _ERR_24_01 = "Fail to draw anything."+_glob_crlf+"Choose a method first" ;
var _ERR_24_02 = "Fail to perform operation: method is unknown."+_glob_crlf+"Please, choose a method" ;
var _ERR_24_03 = "Fail to init items: method is unknown"+_glob_crlf+"Please, choose a method" ;
var _ERR_24_04 = "Fail to fill items: method is unknown."+_glob_crlf+"Please, choose a method" ;
...
var _QUESTION_07 = "Some data have changed, but not saved yet."+_glob_crlf+"If you proceed, you'll lose your changes."+_glob_crlf.repeat(2)+"Continue anyway ?" ;
...
var _QUESTION_10_01 = "Confirm to remove symbols association"+_glob_crlf+"from the selected element ?" ;
var _QUESTION_10_02 = "Confirm to remove symbols association"+_glob_crlf+"from the selected elements ?" ;
...
var _QUESTION_26_01 = "Mobius map params will be reset, according to both method and circles coordinates."+_glob_crlf.repeat(2)+"Continue ?" ;
var _QUESTION_27 = "Confirm to set up a new circles config ?"+_glob_crlf.repeat(2)+"(All settings will be lost)" ;
var _QUESTION_28 = "Action on Mobius map params"+_glob_crlf+"<b>Init</b>: params are set up according to screen circles" ;
var _QUESTION_29 = "Confirm to remove the color?"+_glob_crlf.repeat(2)+"(Note: if the 'fill color' flag is set, then the current palette applies.)" ;
...
function CIRCLES_LABEL_01_FN( _symbol ) { return "Fail to resolve the isometric circles match:"+_glob_crlf+"the element with inverse symbol ('"+_symbol+"') has not been registered yet" ; } 