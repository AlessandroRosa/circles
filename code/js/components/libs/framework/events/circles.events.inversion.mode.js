function Z_PLANE_rendering_layer_canvas_play_inversion_onmousemove( obj, event )
{
      ...
      if ( _glob_disk_sel_index != UNDET )
      {
           ...
           circles_lib_draw_all_complex_disks( _glob_zplane_rendering_layer_pointer.getContext( _glob_canvas_ctx_2D_mode ), zplane_sm, [ _glob_disk_sel_index ], NO );
           ...
           _mouse_event_context = _glob_zplane_rendering_layer_pointer.getContext( _glob_canvas_ctx_2D_mode );
