...
function CIRCLESformsGENERALPURPOSEdispatcher()
{
	if ( arguments.length > 0 )
	{
		...
		switch( MESSAGE_ID )
		{
	        ...
	        var _subset = _glob_popups_array[ POPUP_INDEX ][8], _base_id = _glob_popups_array[ POPUP_INDEX ][12] ;
...
function CIRCLESgeneralpurposeFORMnormalize( _div_id = "", _original_w = UNDET, _original_h = UNDET )
{
	if ( _div_id.length == 0 ) return false ;
    _original_w = safe_int( _original_w, UNDET ), _original_h = safe_int( _original_h, UNDET );
...
function CIRCLESgeneralpurposeFORMminimize( _div_id = "", _original_w = UNDET, _original_h = UNDET )
{
    _original_w = safe_int( _original_w, UNDET ), _original_h = safe_int( _original_h, UNDET );
...
function CIRCLESgeneralpurposeFORMmaximize( _div_id = "", _original_w = UNDET, _original_h = UNDET )
{
    _original_w = safe_int( _original_w, UNDET ), _original_h = safe_int( _original_h, UNDET );
    $( "#PLUGINmasterTABLE" ).css( "width", _original_w + "px" );
    $( "#PLUGINmasterTABLE" ).css( "height", CIRCLES_POPUP_CAPTION_HEIGHT + "px" );
...
function CIRCLESgeneralpurposeFORM( _subset, _base_id, _move, _w, _h, _caption, _x_pos_tag, _y_pos_tag, _bkcolor, _word_wrap, _html_code, _resizable )
{
    ...
    _bkcolor = safe_string( _bkcolor, "black" );
