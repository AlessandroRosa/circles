function circles_lib_canvas_redraw_wplane_entities( _update_plane, _process_title_str, _out_channel )
{
    if ( _glob_rec_canvas_entities_array.size_associative() > 0 )
    {
       ...
       if ( _update_plane )
			 {
					var _ret_chunk = circles_lib_canvas_render_wplane( null, wplane_sm, null, NO, NO, NO, YES, NO, YES, _out_channel );
       ...
       var _canvas = _glob_wplane_rendering_layer_pointer ;
       ...
       CIRCLESmultithreadingPROCESSwindowresize( _options_chunk, YES, _out_channel ) ;
    }
}