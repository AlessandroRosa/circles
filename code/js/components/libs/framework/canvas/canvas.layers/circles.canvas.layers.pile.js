       ...
       else
       {
          ...
          if ( is_html_canvas( _new_layer ) )
          {
            ...
            if ( _plane_type == Z_PLANE )
            {
                ...
                _glob_zplane_topmost_layer_pointer = _new_layer ;
            ...
            else if ( _plane_type == W_PLANE )
            {
                ...
                _glob_wplane_topmost_layer_pointer = _new_layer ;
                if ( function_exists( "circles_lib_statusbar_init" ) ) circles_lib_statusbar_init( NO ); // recomputes z-index
            }
            else return null ;
          }
...
function circles_lib_canvas_layer_pile_resize_to_default( _set_default_coords = NO, _render = YES, _out_channel = OUTPUT_SCREEN )
{
...
function circles_lib_canvas_layer_pile_per_plane_clean( _plane_type, _role, _silent, _out_channel )
{
    _plane_type = circles_lib_return_plane_type( _plane_type ) ;
