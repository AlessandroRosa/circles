function circles_lib_canvas_coords_reset( _plane_type, _render, _output_channel )
{
    ...
    switch( _plane_type )
    {
         ...
         return circles_lib_canvas_render_zplane( null, zplane_sm, null, YES, YES, _render, NO, YES, YES, _output_channel );
         break ;
         case W_PLANE:
         ...
         return circles_lib_canvas_render_wplane( null, wplane_sm, null, NO, YES, _render, YES, NO, YES, _output_channel );
         break ;
         case BIP_BOX:
         ...
         return circles_lib_canvas_render_bipbox( _glob_bip_original_plane_data, null, YES, YES, _render, YES, NO, YES, _output_channel );
         break ;
         default:
...
function circles_lib_canvas_coords_shift( _where, _plane_type, _silent, _render, _output_channel )
{
    _plane_type = circles_lib_return_plane_type( _plane_type ) ;
    ...
    if ( _render && _plane_type.is_one_of( Z_PLANE ) )
    {
       ...
       var _ret_chunk = circles_lib_canvas_render_zplane( null, zplane_sm, null, YES, YES, _render, NO, YES, YES, _output_channel );
    ...
    else if ( _render && _plane_type.is_one_of( W_PLANE ) )
    {
       ...
       var _ret_chunk = circles_lib_canvas_render_wplane( null, wplane_sm, _glob_wplane_selected_items_array, NO, YES, _render, YES, NO, YES, _output_channel );
       var _ret_id = is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
       var _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
    ...
    else if ( _render && _plane_type == BIP_BOX )
    {
       ...
       var _ret_chunk = circles_lib_canvas_render_bipbox( _glob_bip_original_plane_data, _sel_array, YES, YES, _render, YES, NO, YES, _output_channel );
       var _ret_id = is_array( _ret_chunk ) ? safe_int( _ret_chunk[0], NO ) : NO ;
       var _ret_msg = is_array( _ret_chunk ) ? _ret_chunk[1] : _ERR_00_00 ;
...
function circles_lib_canvas_zoom( _plane_type, _mode /* 1: ZOOM IN, 2: ZOOM OUT */, _question, _silent, _render, _output_channel )
{
    _plane_type = circles_lib_return_plane_type( _plane_type ) ;
    _output_channel = safe_int( _output_channel, OUTPUT_SCREEN );
    ...
    switch( _plane_type )
    {
       ...
       _glob_zplaneLEFT = LEFT, _glob_zplaneRIGHT = RIGHT, _glob_zplaneTOP = TOP, _glob_zplaneBOTTOM = BOTTOM ;
       zplane_sm.set_coords_corners( new point( _glob_zplaneLEFT, _glob_zplaneTOP ), new point( _glob_zplaneRIGHT, _glob_zplaneBOTTOM ) );
       if ( _render ) return circles_lib_canvas_render_zplane( null, zplane_sm, null, YES, YES, _render, _question, _silent, YES, _output_channel );
       break ;
       case W_PLANE:
       _glob_wplaneLEFT = LEFT, _glob_wplaneRIGHT = RIGHT, _glob_wplaneTOP = TOP, _glob_wplaneBOTTOM = BOTTOM ;
       wplane_sm.set_coords_corners( new point( _glob_wplaneLEFT, _glob_wplaneTOP ), new point( _glob_wplaneRIGHT, _glob_wplaneBOTTOM ) );
       if ( _render ) return circles_lib_canvas_render_wplane( null, wplane_sm, _glob_wplane_selected_items_array, NO, YES, _render, YES, _question, _silent, _output_channel );
       break ;
       case BIP_BOX:
       _glob_bipLEFT = LEFT, _glob_bipRIGHT = RIGHT, _glob_bipTOP = TOP, _glob_bipBOTTOM = BOTTOM ;
       bipbox_sm.set_coords_corners( new point( _glob_bipLEFT, _glob_bipTOP ), new point( _glob_bipRIGHT, _glob_bipBOTTOM ) );
       ...
       if ( _render ) return circles_lib_canvas_render_bipbox( _glob_bip_original_plane_data, _sel_array, YES, YES, _render, YES, NO, YES, _output_channel );
       break ;
       default: break ;
    }

    return circles_lib_coordinates_set_core( null, null, _plane_type, _silent, _render, NO, _output_channel );
}