function circles_lib_get_screendisk_from_complexdisk( _mapper, _complex_circle )
{
    ...
    return new circle( screen_center_pt, screen_radius, _complex_circle.draw, _complex_circle.fill, _complex_circle.drawcolor, _complex_circle.fillcolor, _complex_circle.linewidth, _complex_circle.notes );
}
...
function circles_lib_screendisk_add( _items_array, _screen_circle, _init, _output_channel )
{
