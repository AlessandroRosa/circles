...
function circles_lib_corners_get_from_obj( _obj ) { return _obj == null ? null : ( typeof ( _obj.corners ) === "function" ? _obj.corners() : null ) ; }
...
function circles_lib_rotate_get_from_obj( _obj, _center, _ang ) { return _obj == null ? null : ( typeof ( _obj.rotate ) === "function" ? _obj.rotate( _center, _ang ) : null ) ; }
function circles_lib_shift_obj( _obj, _shift_x, _shift_y ) { return _obj == null ? null : ( typeof ( _obj.shift ) === "function" ? _obj.shift( _shift_x, _shift_y ) : null ) ; }
