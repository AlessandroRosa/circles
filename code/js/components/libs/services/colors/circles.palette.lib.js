function circles_lib_palette_init( _silent, _out_channel )
{
...
function circles_lib_palette_destroy( _question, _silent, _out_channel )
{
...
function circles_lib_palette_delete_interval( _range_str, _question, _silent, _out_channel )
{
...
function circles_lib_palette_delete_entry( _delete_index, _question, _silent, _out_channel )
{
   _question = safe_int( _question, YES ), _silent = safe_int( _silent, NO );
