...
_glob_bip_canvas_placeholder = _glob_bip_canvas ;
        ...
        stop: function()
              {
                 ...
                 _index = circles_lib_popup_exists( _glob_custom_div.id, POPUP_SEARCH_BY_DIV_ID | POPUP_SEARCH_BY_BASE_ID | POPUP_SEARCH_BY_UNIQUE_ID, _caption );
